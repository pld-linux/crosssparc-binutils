...
Summary(es):	Utilitarios para desarrollo de binarios de la GNU - SPARC binutils
Summary(fr):	Utilitaires de développement binaire de GNU - SPARC binutils
Summary(pl):	Skro¶ne narzêdzia programistyczne GNU dla SPARC - binutils
...
Ten pakiet zawiera wersjê skro¶n± generuj±c± kod dla SPARC.
